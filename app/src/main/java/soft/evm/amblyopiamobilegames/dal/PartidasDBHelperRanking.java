...
public class PartidasDBHelperRanking extends SQLiteOpenHelper {
    ...
    private static final   String SQL_CREATE_PARTIDAS =
            "CREATE TABLE " + TABLE_NAME_RANKING + " (" +
    ...
    private static final   String SQL_DELETE_PARTIDAS =
            "DROP TABLE IF EXISTS " + TABLE_NAME_RANKING;
    ...
    public PartidasDBHelperRanking(Context context){
